...
export class InitSchema1747147517947 implements MigrationInterface {
    name = 'InitSchema1747147517947'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "clientes" ("id" SERIAL NOT NULL, "nombre" character varying(255) NOT NULL, "telefono" character varying(50) NOT NULL, "direccion" character varying(500) NOT NULL, "tipo" character varying(50) NOT NULL, "descuento" numeric(12,2) NOT NULL, "saldo_cuenta_corriente" numeric(14,2) NOT NULL, CONSTRAINT "PK_d76bf3571d906e4e86470482c08" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "productos" ("id" SERIAL NOT NULL, "nombre" character varying(255) NOT NULL, "precio_base" numeric(12,2) NOT NULL, "unidad_id" integer NOT NULL, "tipo_producto_id" integer NOT NULL, "descripcion" text, "vacio" boolean NOT NULL DEFAULT false, "oferta" boolean NOT NULL DEFAULT false, "precio_oferta" numeric(12,2), "activo" boolean NOT NULL DEFAULT true, "imagen" character varying(500), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "id_interno" character varying(100) NOT NULL, CONSTRAINT "UQ_b879d3120c38c1fa4776e81f40e" UNIQUE ("id_interno"), CONSTRAINT "PK_04f604609a0949a7f3b43400766" PRIMARY KEY ("id"))`);
